...
export default function Info() {
  ...
  return (
    <div
      className="w-full py-32 px-8 lg:px-20 mt-20 bg-gradient-to-b from-white to-gray-50"
      id="info"
    >
      {/* Header section */}
      <div className="text-center mb-16">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto mt-8 leading-relaxed"
        >
      ...
      <motion.div
        ...
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16 max-w-7xl mx-auto"
      >
        <motion.div
          variants={itemVariants}
          className="flex flex-col group p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
        >
          <div className="w-16 h-16 mb-6 p-2 rounded-lg bg-blue-50 group-hover:bg-blue-100 transition-colors duration-300">
            <img
              src="./img/connect.svg"
              alt="Connection icon"
